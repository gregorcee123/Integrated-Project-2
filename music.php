...
<html>
    ...
    <body bgcolor="#ff1493">
        ...
        <header class="sport" bgcolor="#ff1493">
            <h1><i class="fa fa-bolt fa-sm"></i>   Quiz Up <span id="music">Music</span></h1>
        ...
        <div id="quizMain">
            <div id="inner">
                ...
                <ul class="category">
                    ...
                    <li id ="music"><a class="on" href="music.php"><i class="fa fa-circle"></i></a></li>
                    <li id="history"><a href="history.php"><i class="fa fa-circle"></i></a></li>
                    <li style="padding-left:5px">Music</li>
                </ul>
...
VALUES (".$userID.", 3, ".$UserFinalscore. ")";
