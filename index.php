...
<html>
    <head>
        ...
        <?php $_SESSION["currentPage"] = 'index.php'; ?>
        ...
        <div id="quizMain">
            <div id="inner">
                ...
                <ul class="category">
                    ...
                    <li id="general" ><a class="on" href="index.php"><i class="fa fa-circle fa-xs"></i></a></li>
                    <li id ="sports"><a href="sport.php"><i class="fa fa-circle fa-xs"></i></a></li>
                    <li id ="music"><a href="music.php"><i class="fa fa-circle"></i></a></li>
                    <li id="history"><a href="history.php"><i class="fa fa-circle"></i></a></li>
                    <li style="padding-left:5px">General</li>
                </ul>
...
?></span><p id="innerQuestion"></p></p>
                ...
                <div id="answers">
                    <div id="a1"><p><input id="A1" type="radio" name="gender" value="1"><span style="margin-left:10px;margin-right:5px;">A    </span><span style="font-weight: normal;" id="innerA1"></span></p></div>
                    <div id="a2"><p><input type="radio" name="gender" value="2"><span style="margin-left:10px;margin-right:5px;">B    </span><span style="font-weight: normal;" id="innerA2"></span></p></div>
...
VALUES (".$userID.", 1, ".$UserFinalscore. ")";
