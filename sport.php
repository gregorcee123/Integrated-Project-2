...
<html>
    ...
    <body bgcolor="dodgerblue">
        ...
        <header class="sport" bgcolor="dodgerblue">
            <h1><i class="fa fa-bolt fa-sm"></i>   Quiz Up <span id="sport">sport</span></h1>
...
?>
        ...
        <p><a href="restart.php" >Try again </a> or choose another category</a>
                    ...
                    <li id ="music"><a href="music.php"><i class="fa fa-circle"></i></a></li>
                    <li id="history"><a href="history.php"><i class="fa fa-circle"></i></a></li>
                    <li style="padding-left:5px">Sport</li>
                </ul>
            </div>
...
VALUES (".$userID.", 2, ".$UserFinalscore. ")";
